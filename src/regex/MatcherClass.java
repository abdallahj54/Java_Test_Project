...
public class MatcherClass {
    public static void main(String[] args) {
        ...
        System.out.println("\n---Testing out Custom Regex Pattern without Claiming it first---");
        System.out.println(Pattern.matches("[a-zA-Z0-9_-]{9,15}", "TechGlobal")); // true
        System.out.println(Pattern.matches("[a-zA-Z0-9_-]{9,15}", "Tech_Global-")); // true
        System.out.println(Pattern.matches("[a-zA-Z0-9_-]{9,15}", "Tech_Global-----")); // false
        System.out.println(Pattern.matches("[a-zA-Z0-9_-]{9,15}", "TechGlobal$")); // false
